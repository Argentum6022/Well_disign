...
def construction(H_intervals, intervals,Q,well_type):
    ...
    for i in range(intervals):
        ...
        #Db-диаметр долота,мм Dm-диаметр муфты,мм D-наружный диаметр колонны,
        # мм d-внутренний диаметр колонны,мм s-толщина стенки колонны,мм size-типоразмер H_intervals-глубина спуска,м
